...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      transcriptTextSizeDesc: '对话记录文字的大小。',
      transcriptTextSizeSmall: '小',
      transcriptTextSizeMedium: '中',
      transcriptTextSizeLarge: '大',
      transcriptWidthTitle: '对话宽度',
      transcriptWidthDesc: '对话记录与输入框的最大宽度。',
      transcriptWidthNarrow: '窄',
      transcriptWidthMedium: '中等',
      transcriptWidthWide: '宽',
      uiScaleTitle: '界面缩放',
