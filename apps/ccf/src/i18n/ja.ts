...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      transcriptTextSizeDesc: '会話の文字サイズです。',
      transcriptTextSizeSmall: '小',
      transcriptTextSizeMedium: '中',
      transcriptTextSizeLarge: '大',
      transcriptWidthTitle: '会話の幅',
      transcriptWidthDesc: '会話と入力欄の最大幅です。',
      transcriptWidthNarrow: '狭い',
      transcriptWidthMedium: '普通',
      transcriptWidthWide: '広い',
