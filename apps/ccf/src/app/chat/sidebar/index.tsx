                ...
                const button = (
                  <SidebarMenuButton
                    ...
                    className={cn(
                      ...
                      // thread.tsx.
                      'flex h-7 w-full justify-start gap-2 rounded-[8px] border border-transparent px-2 text-left text-[0.8125rem] font-medium text-(--ui-text-secondary) transition-colors duration-100 ease-out [-webkit-app-region:no-drag] hover:bg-(--ui-control-hover-background) hover:text-foreground hover:transition-none',
                      active &&
        ...
        {showSessionSections && (
          <div className={cn('flex min-h-0 flex-1 flex-col pb-1.75', SCROLL_Y)}>
            ...
            {!trimmedQuery && pinnedSessions.length > 0 && (
              <SidebarSessionsSection
                activeSessionId={activeSidebarSessionId}
                contentClassName={cn('flex max-h-44 flex-col gap-px rounded-lg px-0.5 pb-2 pt-1', GROUP_BODY)}
            ...
            {!trimmedQuery && (
              <SidebarSessionsSection
                ...
                contentClassName={cn(
                  'flex min-h-0 flex-1 flex-col px-0.5 pb-1.75 pt-1',
                  SCROLL_Y,
