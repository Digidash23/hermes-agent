...
import { $attentionSessionIds, $stalledSessionIds, $unreadFinishedSessionIds } from '@/store/session'
...
export function SidebarSessionRow({
  ...
  // Resolve the dot's display state once — the five signals are mutually
  ...
  return (
    ...
    >
      <SidebarRowShell
        ...
        {...rest}
      >
        {sessionShowsRunningArc({ isWorking, needsInput }) && <span aria-hidden="true" className="session-glow" />}
        <SidebarRowBody
